...
room01Actors
  .set("tp01", new Teleporter("tp01", new Vector2D(0, 12), new Vector2D(0.25, 3), "null",
    new Level(room02, room02Actors), new Vector2D(30.625, 13), false))
  .set("tp02", new Teleporter("tp02", new Vector2D(0, 0), new Vector2D(0.25, 4), "null",
    new Level(room02, room02Actors), new Vector2D(30.625, 2), false))
room02Actors
  .set("tp01", new Teleporter("tp01", new Vector2D(31.75, 12), new Vector2D(0.25, 3), "null",
    new Level(room01, room01Actors), new Vector2D(0.375, 13), true))
  .set("tp02", new Teleporter("tp02", new Vector2D(31.75, 0), new Vector2D(0.25, 4), "null",
    new Level(room01, room01Actors), new Vector2D(0.375, 2), true))